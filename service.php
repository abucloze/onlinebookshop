    ...
    <header>
     ...
     <section class="home">
        <div class="home-text">
            ...
            <h4>Become an Admin an get paid uploading revision materials</h4>
            <h1>Get Brains</h1>
            <a href="adminsignup.php" class="btn">Be part of us</a>
        </div>
        ...
        include 'filesdownload.php';
         ...
         $squery = mysqli_query($conn, $selectQuery);
          while (($result = mysqli_fetch_assoc($squery))) {
            ...
            <div class="box">
                <div class="box-img">
                    <a href="index2.php?file_id=<?php echo $result['id'] ?>">
