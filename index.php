    ...
    <header>
     ...
     <section class="home">
        <div class="home-text">
            ...
            <h1>Get brains</h1>
            <a href="php/signup.php" class="btn">Explore</a>
        </div>
        ...
        include 'php/filesdownload.php';
         ...
         $squery = mysqli_query($conn, $selectQuery);
          while (($result = mysqli_fetch_assoc($squery))) {
            ...
            <div class="box">
                <div class="box-img">
                    <a href="index.php?file_id=<?php echo $result['id'] ?>">
                        <img src="img/pdf.png" alt="">
                        <h3><?php echo $result['username']; ?></h3></a>
                </div>   
            </div>
          <?php
          }
        ...
        <section class="contact">
            <div class="main-contact">
                ...
                <div class="contact-content">
                    ...
                    <li><a href="php/about.php">About</a></li>
                    <li><a href="">Contact</a></li>
                    <li><a href="php/adminsignup.php">Become Admin</a></li>
                </div>
            </div>
